...
- Determinism: with the same dictionary and input, output is fully deterministic.
...
def reconstruct(s: str, dict_words: set[str]) -> list[str] | None:
    ...
    # PRUNING: limit candidate word lengths to <= max_len to keep inner loop bounded (≈ O(n·L)).
...
def main():
    """Read input, run DP segmentation, print sentence or Nonsense (deterministic)."""
...
# - Word Break (problem framing): https://leetcode.com/problems/word-break/
# - DP explanations/variants: https://www.geeksforgeeks.org/word-break-problem-dp-32/
# - Cost-based segmentation inspiration (unigram/bigram style): https://norvig.com/ngrams/
# - Library inspired by Norvig-style segmentation: https://github.com/grantjenks/python-wordsegment
# ---------------------------------------------------------------------------
